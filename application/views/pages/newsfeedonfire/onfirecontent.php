          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="callout callout-info">
                <h4>Hello Edelito! You caught us before we're ready.</h4>
                  ...
                  <div class="box box-widget">
                    <div class='box-header with-border'>
                      <div class='user-block'>
                        ...
                        <span class='username'><a href="#">Alfie Dimpas</a>&nbsp;&nbsp;<i class='fa fa-star' style="color:#ffd700;"></i><b>&nbsp;&nbsp;50</b></span>
                    ...
                    <div class='box-body'>
                      <!-- post text -->
                      <p>This page is about punchline.The word for the day is King Ko!</p>
                      <p>Who will win in this fight? Find out.</p>

                      <!-- Attachment -->
                      <div class="attachment-block clearfix">
                        <img class="attachment-img" src="../../dist/img/punch.jpg" alt="attachment image">
                      ...
                      <span class='pull-right text-muted'>4 likes - 7 comments</span>
                    </div><!-- /.box-body -->
                    <div class='box-footer box-comments'>
                      <div class='box-comment'>
                        ...
                        <div class='comment-text'>
                          ...
                          King ko? Mao na siya ang Gorilla? Ahaha.., murag c edelito :p<br/>
                          <button class='btn btn-default btn-xs'><i class='fa fa-thumbs-o-up'></i> Upvote</button>
                      ...
                      <div class='box-comment'>
                        ...
                        <div class='comment-text'>
                          <span class="username">
                            ...
                            <span class='text-muted pull-right'>8:06 PM Today</span>
                          </span><!-- /.username -->
                          Mao man gyud ng bata nga mangayo ug five pesos.., gae ko king ko ma! Ahahah.<br/>
                          <button class='btn btn-default btn-xs'><i class='fa fa-thumbs-o-up'></i> Upvote</button>
                          <button class='btn btn-default btn-xs'><i class='fa fa-reply'></i> Reply</button><br/>
                          <form action="#" method="post">
                            <img class='img-circle img-sm' src='../../images/team/index2.jpg' alt='user image'>
                        <div class='comment-text'>
                          <span class="username">
                            Alfie Dimpas
                            <span class='text-muted pull-right'>8:08PM Today</span>
                          </span><!-- /.username -->
                          Imbaha edelitz dah!<br/>
                          <button class='btn btn-default btn-xs'><i class='fa fa-thumbs-o-up'></i> Upvote</button>
                          <button class='btn btn-default btn-xs'><i class='fa fa-reply'></i> Reply</button><br/>
                            <img class='img-circle img-sm' src='../../images/team/index3.jpg' alt='user image'>
                        <div class='comment-text'>
                          <span class="username">
                            Edelito D. Albaracin Jr.
                            <span class='text-muted pull-right'>8:10 PM Today</span>
                          </span><!-- /.username -->
                          Salamat Alf :)<br/>
                          <button class='btn btn-default btn-xs'><i class='fa fa-thumbs-o-up'></i> Upvote</button>
                          <button class='btn btn-default btn-xs'><i class='fa fa-reply'></i> Reply</button><br/>
                      ...
                      <div class='box-comment'>
                        ...
                        <div class='comment-text'>
                          <span class="username">
                            Lyneth Cutamora
                            <span class='text-muted pull-right'>8:12 PM Today</span>
                          </span><!-- /.username -->
                          Hmmmmm.., pildi ko dah!<br/>
                          <button class='btn btn-default btn-xs'><i class='fa fa-thumbs-o-up'></i> Upvote</button>
                          <button class='btn btn-default btn-xs'><i class='fa fa-reply'></i> Reply</button><br/>
                          <form action="#" method="post">
                            <img class='img-circle img-sm' src='../../images/team/index3.jpg' alt='user image'>
                        <div class='comment-text'>
                          <span class="username">
                            Edelito D. Albaracin Jr.
                            <span class='text-muted pull-right'>8:14PM Today</span>
                          </span><!-- /.username -->
                          3-0!<br/>
                          <button class='btn btn-default btn-xs'><i class='fa fa-thumbs-o-up'></i> Upvote</button>
                          <button class='btn btn-default btn-xs'><i class='fa fa-reply'></i> Reply</button><br/>
