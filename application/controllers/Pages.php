...
class Pages extends CI_Controller {
 ...
 //        return $query;
	...
	public function notif($key=null,$id=null)
	{
		...
		public function newShowInvestorPost()
		{
			  foreach ($this->post->queryInvestorPost()->result_array() as $row):
		...
		public function newnewsfeedideator()
		{
			  foreach ($this->post->queryNewsfeedIdeator()->result_array() as $row):
		  ...
		  echo '     <div class="col-md-12">
		           ...
		           echo    '
		                        ...
		                        <td><small style="text-align:justify;text-justify:inter-word;">';
		                        $this->post->bmcexplode($row1['key_resources']);
		           echo    '
		                            </small>
		                        </td>
		                      </tr>
